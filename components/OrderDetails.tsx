...
export default function Orderdetails(props: Props) {
  return (
    <Modal
      ...
      dontShowSubmitBtn={props.dontShowSubmitBtn}
    >   
        <h3>Customer Info</h3>
        ...
        <div className="order-row">
            <p>Customer Bank: <strong>{props.orderBank ? `${props.orderBank.accountNumber} ${props.orderBank.bankName} ` : ''}</strong></p>
        ...
        <p>{props.order?.details.xb_transactionRef}</p>
